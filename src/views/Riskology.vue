...
const risks = reactive<Risk[]>([
    {
        ...
        description: 'Fehlerhafte Zeit- und Aufwandsschätzung zu Projektbeginn.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 55,
    ...
    },
    {
        id: 2,
        title: "Fluktuation",
        description: 'Personelle Fluktuation und deren Auswirkungen.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 8,
    ...
    {
        id: 3,
        title: "Anforderungswachstum",
        description: 'Funktionale Inflation (kontinuierliches Wachstum des Anforderungsumfangs).',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 16,
    ...
    {
        id: 4,
        title: "Spezifikationskollaps",
        description: 'Scheitern beim Erreichen eines gemeinsamen Konsenses bezüglich der Anforderungen.',
        status: true,
        isBinaryRisk: true,
        riskSpec: {
            worstPenalty: 0,
    ...
    {
        id: 5,
        title: "Produktivitätsschwankungen",
        description: 'Abweichungen und Schwankungen in der Entwicklerproduktivität.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 15,
    ...
    {
        id: 6,
        title: "Falsches UI/UX-Design",
        description: 'Die Software erfüllt zwar technisch alle Funktionen, ist aber so kompliziert oder kontraintuitiv zu bedienen, dass die Endnutzer sie ablehnen.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 7,
        title: "Widerstand der Endnutzer",
        description: 'Nutzer weigern sich, etablierte Arbeitsweisen für das neue System aufzugeben. Dies tritt häufig auf, wenn die Betroffenen nicht frühzeitig in den Entwicklungsprozess eingebunden werden.',
        status: true,
        isBinaryRisk: true,
        riskSpec: {
            worstPenalty: 0,
    ...
    {
        id: 8,
        title: "Überreizung technologischer Grenzen",
        description: 'Das Projekt setzt auf Algorithmen oder Technologien (z. B. bleeding-edge KI oder ungetestete Krypto-Bibliotheken), die in der Theorie funktionieren, in der Praxis aber noch unreif, fehlerhaft oder nicht performant genug sind.',
        status: true,
        isBinaryRisk: true,
        riskSpec: {
            worstPenalty: 0,
    ...
    {
        id: 9,
        title: "Mängel bei Drittkomponenten",
        description: 'Das Projekt verlässt sich auf externe Softwarepakete, Open-Source-Bibliotheken oder APIs. Wenn diese fehlerhaft sind, nicht mehr gewartet werden oder Sicherheitslücken aufweisen, steht die eigene Entwicklung still.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 10,
        title: "Leistungseinbrüche unter Last",
        description: 'Die Software blockiert, stürzt ab oder reagiert zu langsam, sobald sie vom Testsystem in die echte Produktionsumgebung mit realen Datenmengen übergeben wird.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 11,
        title: "Mängel bei Zulieferern/Outsourcing",
        description: 'Externe Dienstleister, Agenturen oder Nearshore-Partner liefern ihren Code verspätet oder in ungenügender Qualität ab.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 12,
        title: "Fehlender Rückhalt im Top-Management",
        description: 'Sobald das Projekt in eine Krise gerät oder teurer wird, fehlt ein starker Fürsprecher in der Führungsebene. Das führt oft zum plötzlichen Entzug des Budgets.',
        status: true,
        isBinaryRisk: true,
        riskSpec: {
            worstPenalty: 0,
    ...
    },
    {
        ...
        description: 'Verdeckte Konflikte zwischen Abteilungen oder plötzliche Wechsel im Management führen dazu, dass sich Prioritäten verschieben und das Projekt blockiert wird.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 14,
        title: "Zusammengestrichene Testphase",
        description: 'Da die Entwicklung meist länger dauert als geplant, wird am Ende des Projekts die Zeit für Softwaretests und Quality Assurance (QA) massiv verkürzt. Die Software wird mit kritischen Bugs ausgeliefert.',
        status: true,
        isBinaryRisk: false,
        riskSpec: {
            worstPenalty: 10,
    ...
    {
        id: 15,
        title: "Supply-Chain-Risiko",
        description: 'Das blinde Einbinden von Sub-Bibliotheken, ohne deren Lizenzierungsrechte (z. B. DSGVO-Verstöße oder restriktive Open-Source-Lizenzen) oder IT-Sicherheit zu prüfen.',
        status: true,
        isBinaryRisk: true,
        riskSpec: {
            worstPenalty: 10,
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex w-100 justify-content-between">
                    <h4>Most Likely Completion Date (Median)</h4>
                    <h4>{{ median }}</h4>
                </div>
                <div class="d-flex w-100 justify-content-between">
